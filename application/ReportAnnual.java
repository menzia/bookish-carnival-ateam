...
public class ReportAnnual extends Stage {
	...
	/**
	 * Tries to print the annual report for the given data to the given directory.
	 * 
	 * @param dir directory to save file to
	 * @param farmLand to get data from
	 * @param yearNum of year to print report on
	 */
	public static void printToDirectory(File dir, FarmLand farmLand, Integer yearNum) {
		
		File file = null;//file where the report will be written
		
		try {
			
			file = new File(dir, "/AnnualReport-" + yearNum + ".txt");
			...
			wrter.write("Annual Report: " + yearNum + "\n\n");
