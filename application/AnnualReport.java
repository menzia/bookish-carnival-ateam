...
public class AnnualReport extends Stage {
	...
	private static TableColumn<FarmRow,String> totalWeights = new TableColumn<FarmRow, String>("Total Milk Weight(lbs)");
	...
	public static class FarmRow {
		...
		private FarmRow(String farm, String weights, String percentage) {
	...
	/**
	 * Creates an ObservableList of FarmRows with the data corresponding to the given year
	 * and returns it
	 * 
	...
	private static ObservableList<FarmRow> getData(FarmLand farmLand,Integer yearNum) {
		ArrayList<FarmRow> farmList = new ArrayList<FarmRow>();
			...
			for (String farm : farmLand.getFarms()) {
				...
				FarmRow newFarmRow = new FarmRow(farmString, weightString, percentageString);
